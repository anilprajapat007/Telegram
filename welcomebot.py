...
GROUP_RULES = (
    "📢 *ग्रुप के नियम* 📢\n\n"
    "1️⃣ *ज़रूरी नियम* – मूवीज़ की रिक्वेस्ट करने के लिए हमारे [YouTube चैनल]"
    "(https://youtube.com/@iluprajapat) और [Instagram]"
    "(https://www.instagram.com/anilkumarbci/) को जॉइन करें।  \n"
...
async def welcome(update, context):
    ...
    for new_member in update.message.new_chat_members:
        # Escape the exclamation mark for MarkdownV2 by prefixing with a backslash
